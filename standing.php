...
$teams_info = $db->fetch_all_array("SELECT * FROM bud13_account");
...
<h1>순위표
<a href='s_team.html' target="_blank"><span class='badge badge-success'>단체순위</span></a> 
<a href='s_single.html' target="_blank"><span class='badge badge-info'>개인 순위</span></a></hA1>
</div> 
...
foreach( $teams_info as $index => $value ) {
	...
	$group = ($teams_info[$index]["nmember"] == 1 ? "개인" : "단체" );
	...
	if( $group == "개인" ) $groupClass = "label-info";
	else $groupClass = "label-success";
?>
<tr>
...
<td>
<span class='label <?=$groupClass;?>'><?=$group;?></span>
</td>
<td>
<?=$score;?>
</td>
